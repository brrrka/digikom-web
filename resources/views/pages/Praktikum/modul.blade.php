       ...
       <div class="container mx-auto px-12 pt-12 flex-wrap flex justify-center items-center gap-8">
           ...
           <div class="w-52 relative group">
               ...
               <div class="absolute top-full left-0 w-full bg-white p-4 rounded-2xl shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-300 ease-in-out z-10">
                   <a class="flex justify-center items-center text-white h-10 w-full bg-gradient-to-r from-gray-950 to-dark-green text-sm rounded-lg mb-4" href="{{ route('moduls.download', $modul->id) }}">Download Modul</a>
                   <a href="" class="flex justify-center items-center text-dark-green-3 h-10 w-full bg-transparent p-[1px] bg-gradient-to-r from-gray-950 to-dark-green-2 text-sm rounded-lg">
