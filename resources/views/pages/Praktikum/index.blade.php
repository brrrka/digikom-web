<x-app-layout>
    <section class="min-h-screen relative text-dark-green bg-gradient-to-t from-light-green to-white">
        ...
        <div class="absolute inset-0 z-10 flex justify-between items-center container mx-auto h-screen px-24">
