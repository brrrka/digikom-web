<x-app-layout>
    <section
        ...
        <div
            class="flex gap-6 md:gap-10 lg:gap-16 justify-center items-center h-full w-full md:h-fit lg:h-full flex-wrap">
            @foreach ($praktikums as $praktikum)
                <a href="{{ route('moduls.praktikum', $praktikum->slug) }}"
                    class="lg:h-72 h-80 w-64 border border-dark shadow-xl hover:bg-gradient-to-t from-primary to-gray-950 hover:text-white transition-all duration-500 bg-white rounded-2xl flex justify-center items-center flex-col gap-2 z-10">
