    ...
    <section class="flex h-dvh justify-center items-center overflow-hidden relative" id="home">
        ...
        <div class="h-full w-full flex justify-center items-center flex-wrap flex-col md:flex-row">
            <div class="flex-1 text-center md:text-start w-full md:order-1 order-2 text-wrap relative h-full">
                <div class="carousel-text absolute inset-0 top-0 md:-top-10 lg:top-4 h-full md:pl-12 px-6 md:pr-5 flex flex-col justify-center transition-all duration-300 ease-in-out opacity-0">
            ...
            <div class="flex-1 justify-center w-full md:order-2 order-1 flex items-center h-full relative">
                <div class="absolute inset-0 md:right-14 top-16 right-2 md:-top-6 lg:top-2 h-full flex items-center md:justify-end justify-center z-10">
                    <img src="{{ asset('images/Ellipse1.png') }}" class="lg:w-96 md:w-80 w-60" alt="Ellips" loading="lazy">
                </div>
                <div class="carousel-image absolute inset-0 top-15 md:-top-8 lg:-top-0 md:right-12 h-full flex items-center md:justify-end justify-center transition-all duration-300 ease-in-out opacity-0">
                    <img class="lg:w-96 md:w-80 w-60 bg-light rounded-full" src="{{ asset('images/Inti.png') }}" alt="Inti" loading="lazy">
                </div>
                <div class="carousel-image absolute inset-0 top-15 md:-top-8 lg:-top-0 md:right-12 h-full flex items-center md:justify-end justify-center transition-all duration-300 ease-in-out opacity-0">
                    <img class="lg:w-96 md:w-80 w-60 bg-light rounded-full" src="{{ asset('images/IPI.png') }}" alt="IPI" loading="lazy">
                </div>
                <div class="carousel-image absolute inset-0 top-15 md:-top-8 lg:-top-0 md:right-12 h-full flex items-center md:justify-end justify-center transition-all duration-300 ease-in-out opacity-0">
                    <img class="lg:w-96 md:w-80 w-60 bg-light rounded-full" src="{{ asset('images/Multimedia.png') }}" alt="Multimedia" loading="lazy">
                </div>
                <div class="carousel-image absolute inset-0 top-15 md:-top-8 lg:-top-0 md:right-12 h-full flex items-center md:justify-end justify-center transition-all duration-300 ease-in-out opacity-0">
                    <img class="lg:w-96 md:w-80 w-60 bg-light rounded-full" src="{{ asset('images/RnD.png') }}" alt="RnD" loading="lazy">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="pt-28 text-dark-digikom relative min-h-125 md:min-h-150 lg:h-screen w-full" id="about">
        ...
        <div class="relative w-full lg:overflow-hidden lg:h-full">
            <div class="absolute inset-0 max-w-lg lg:max-w-2xl z-30 px-5 md:pl-12 md:pr-12">
                ...
                <h1 class="text-xl md:text-4xl leading-tight font-bold my-4 text-pretty">Your <span class="text-primary">Gateway</span> to <span class="text-primary">Cutting-Edge</span> Digital and Architecture Computer</h1>
    ...
    <section class="py-8 md:py-20 lg:py-12">
        ...
        <div class="hidden md:grid grid-cols-10 gap-8 lg:gap-4 text-white">
            <div class="col-span-10 lg:col-span-4 grid grid-rows-4 gap-4">
                <div class="row-span-1 bg-primary/15 h-14 rounded-r-2xl items-transparent-primary transition-all duration-200"></div>
            ...
            <div class="col-span-10 lg:col-span-2 grid grid-rows-4 gap-4">
                <div class="row-span-1 grid grid-cols-6 gap-3">
                    <div class="col-span-2 lg:hidden h-14 bg-dark-digikom/15 rounded-2xl items-transparent-dark transition-all duration-200"></div>
                    ...
                    <div class="col-span-2 lg:hidden bg-dark-digikom/15 rounded-2xl items-transparent-dark transition-all duration-200"></div>
                </div>
                <div class="row-span-2 grid grid-cols-6 gap-3">
                    <div class="col-span-2 lg:hidden bg-dark-digikom/15 rounded-2xl items-transparent-dark transition-all duration-200"></div>
                    <div class="col-span-2 lg:col-span-6 grid place-items-center rounded-2xl px-2 bg-dark-digikom item-2 transition-all duration-200">
                ...
                <div class="row-span-1 bg-dark-digikom/15 rounded-2xl items-transparent-dark transition-all duration-200"></div>
            </div>
            <div class="col-span-10 lg:col-span-4 grid grid-rows-4 gap-4">
                <div class="row-span-1 bg-red-digikom/15 h-14 rounded-l-2xl items-transparent-red transition-all duration-200"></div>
                <div class="row-span-1 grid grid-cols-6 gap-3">
                    <div class="col-span-2 lg:col-span-1 bg-red-digikom/15 rounded-2xl items-transparent-red transition-all duration-200"></div>
