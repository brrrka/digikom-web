<x-app-layout>
    <section class="flex h-dvh justify-center items-center relative" id="home">
        ...
        <div class="h-full w-full flex justify-center items-center flex-wrap flex-col md:flex-row">
            <div class="flex-1 text-center md:text-start w-full md:order-1 order-2 text-wrap relative h-full">
                ...
                <div class="carousel-text absolute inset-0 -top-2 md:-top-10 lg:top-4 h-full md:pl-12 px-8 md:pr-5 flex flex-col justify-center transition-all duration-300 ease-in-out opacity-0">
                ...
                <a href="" class="absolute bottom-4 left-1/2 -translate-x-1/2 md:translate-x-0 md:left-12 md:bottom-96 lg:bottom-16 rounded-full bg-primary px-8 py-2 text-black font-semibold">
                    Learn More
                </a>
            </div>
    ...
    <section class="py-8 md:py-20 lg:py-12">
        ...
        <div class="flex md:hidden bg-black p-4 space-x-6 text-white snap-x overflow-x-scroll">
