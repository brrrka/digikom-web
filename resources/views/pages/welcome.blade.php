<x-app-layout>
    <section class="flex h-dvh justify-center items-center relative" id="home">
        <img class="hidden md:block absolute top-44 w-32 left-0 lg:top-28 lg:w-20" src="{{ asset('images/Item1.png') }}"
            alt="Item 1" loading="lazy">
        <img class="hidden md:block absolute w-32 right-0 bottom-48 lg:bottom-0" src="{{ asset('images/Item3.png') }}"
            alt="Item 3">
        <img class="hidden md:block absolute w-16 left-0 bottom-24 lg:-bottom-20" src="{{ asset('images/Item6.png') }}"
            alt="Item 6">
        <div class="h-full w-full flex justify-center items-center flex-wrap flex-col md:flex-row">
            <div class="flex-1 text-center md:text-start w-full md:order-1 order-2 text-wrap relative h-full">
                <img class="hidden md:block absolute top-44 w-48 right-0 lg:top-24 lg:w-36"
                    src="{{ asset('images/Item2.png') }}" alt="Item 2" loading="lazy">
                <img class="hidden md:block absolute bottom-96 lg:bottom-24 right-0 w-40"
                    src="{{ asset('images/Ellipse2.png') }}" alt="Item 2" loading="lazy">

                <div
                    class="carousel-text absolute inset-0 top-0 md:-top-10 lg:top-4 h-full md:pl-12 px-4 md:pr-5 flex flex-col justify-center transition-all duration-300 ease-in-out opacity-0">
            ...
            <div class="flex-1 justify-center w-full md:order-2 order-1 flex items-center h-full relative">
                <div
                    class="absolute inset-0 md:right-14 top-15 right-2 md:-top-6 lg:top-2 h-full flex items-center md:justify-end justify-center z-10">
                    <img src="{{ asset('images/Ellipse1.png') }}" class="lg:w-96 md:w-80 w-64" alt="Ellips"
                        loading="lazy">
                </div>
                <div
                    class="carousel-image absolute inset-0 top-14 md:-top-8 lg:-top-0 md:right-12 h-full flex items-center md:justify-end justify-center transition-all duration-300 ease-in-out opacity-0">
                    <img class="lg:w-96 md:w-80 w-64 bg-light rounded-full" src="{{ asset('images/Inti.png') }}"
                        alt="Inti" loading="lazy">
                </div>
                <div
                    class="carousel-image absolute inset-0 top-14 md:-top-8 lg:-top-0 md:right-12 h-full flex items-center md:justify-end justify-center transition-all duration-300 ease-in-out opacity-0">
                    <img class="lg:w-96 md:w-80 w-64 bg-light rounded-full" src="{{ asset('images/IPI.png') }}"
                        alt="IPI" loading="lazy">
                </div>
                <div
                    class="carousel-image absolute inset-0 top-14 md:-top-8 lg:-top-0 md:right-12 h-full flex items-center md:justify-end justify-center transition-all duration-300 ease-in-out opacity-0">
                    <img class="lg:w-96 md:w-80 w-64 bg-light rounded-full" src="{{ asset('images/Multimedia.png') }}"
                        alt="Multimedia" loading="lazy">
                </div>
                <div
                    class="carousel-image absolute inset-0 top-14 md:-top-8 lg:-top-0 md:right-12 h-full flex items-center md:justify-end justify-center transition-all duration-300 ease-in-out opacity-0">
                    <img class="lg:w-96 md:w-80 w-64 bg-light rounded-full" src="{{ asset('images/RnD.png') }}"
    ...
    <section class="pt-40 text-dark-digikom relative overflow-hidden min-h-125 md:min-h-150 lg:h-screen w-full"
        id="about">
        <div class="relative w-full">
            <div class="absolute inset-0 max-w-xl lg:max-w-2xl z-30 pl-12 pr-12">
                <h5 class="font-bold text-primary">ABOUT</h5>
                <h1 class="text-xl md:text-4xl leading-tight font-bold my-4">Your <span
            ...
            <div id="image-container"
                class="absolute min-w-sm top-28 -right-56 md:-right-96 md:-top-20 lg:-top-4 lg:-right-10 md:min-w-md lg:max-w-2xl z-20">
                <img class="absolute transition-opacity duration-1000 opacity-0" src="{{ asset('images/Item4.png') }}"
                    alt="Item 4">
                <img class="absolute transition-opacity duration-1000 opacity-0"
                    src="{{ asset('images/Item4-b.png') }}" alt="Item 4">
                <img class="absolute transition-opacity duration-1000 opacity-0"
                    src="{{ asset('images/Item4-c.png') }}" alt="Item 4">
                <img class="absolute transition-opacity duration-1000 opacity-0"
                    src="{{ asset('images/Item4-d.png') }}" alt="Item 4">
            </div>
    ...
    <section class="py-8 md:py-20 lg:py-12">
        ...
        <div class="hidden md:grid grid-cols-10 gap-8 lg:gap-4 text-white group">
            <div class="col-span-10 lg:col-span-4 grid grid-rows-4 gap-4">
                <div class="row-span-1 bg-primary/5 h-14 rounded-r-2xl items-transparent transition-all duration-200">
                </div>
                <div class="row-span-1 grid grid-cols-6 gap-3">
                    <div
                        class="col-span-2 lg:col-span-2 bg-primary/5 rounded-r-2xl items-transparent transition-all duration-200">
                    </div>
                    <div
                    ...
                    <div
                        class="col-span-2 lg:col-span-1 bg-primary/5 rounded-2xl items-transparent transition-all duration-200">
                    </div>
                </div>
            ...
            <div class="col-span-10 lg:col-span-2 grid grid-rows-4 gap-4">
                <div class="row-span-1 grid grid-cols-6 gap-3">
                    <div
                        class="col-span-2 lg:hidden h-14 bg-dark-digikom/5 rounded-2xl items-transparent transition-all duration-200">
                    </div>
                    <div
                    ...
                    <div
                        class="col-span-2 lg:hidden bg-dark-digikom/5 rounded-2xl items-transparent transition-all duration-200">
                    </div>
                </div>
                <div class="row-span-2 grid grid-cols-6 gap-3">
                    <div
                ...
                <div class="row-span-1 bg-dark-digikom/5 rounded-2xl items-transparent transition-all duration-200">
                </div>
            </div>
            <div class="col-span-10 lg:col-span-4 grid grid-rows-4 gap-4">
                <div
                    class="row-span-1 bg-red-digikom/5 h-14 rounded-l-2xl items-transparent transition-all duration-200">
                </div>
                <div class="row-span-1 grid grid-cols-6 gap-3">
                    <div
                        class="col-span-2 lg:col-span-1 bg-red-digikom/5 rounded-2xl items-transparent transition-all duration-200">
                    </div>
                    <div
                    ...
                    <div
                        class="col-span-2 lg:col-span-2 bg-red-digikom/5 rounded-l-xl items-transparent transition-all duration-200">
                    </div>
                </div>
                <div class="row-span-2 grid grid-cols-6 gap-3">
                    <div
