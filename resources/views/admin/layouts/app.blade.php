...
<head>
    ...
    <title>@yield('title', 'Admin Panel') - Digikom Lab</title>
...
<body class="h-full bg-gray-50 font-sans">
    <div x-data="{ sidebarOpen: false }" class="flex h-full">
        <!-- Mobile Sidebar -->
        <div class="fixed inset-y-0 z-50 flex w-72 flex-col lg:hidden" x-show="sidebarOpen"
            ...
            <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4 shadow-xl">
                <div class="flex h-16 shrink-0 items-center border-b border-gray-200">
                    <img class="h-10 w-auto" src="{{ asset('images/LogoDigikom.png') }}" alt="Digikom Lab">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button type="button" class="-m-1.5 flex items-center p-1.5" @click="open = !open">
                                ...
                                <span class="hidden lg:flex lg:items-center">
                                    <span
                                        class="ml-4 text-sm font-semibold leading-6 text-gray-900">{{ auth()->user()->name }}</span>
                                ...
                                <a href="{{ route('home') }}"
                                    ...
                                    <div class="flex items-center">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m0 0h3m0 0h3a1 1 0 001-1V10M9 21h6">
                                            </path>
                                        </svg>
                                        Ke Website
                                    </div>
            ...
            <main class="flex-1">
                @if (session('success'))
                    <div class="mx-4 mt-4 sm:mx-6 lg:mx-8">
                        <div class="rounded-md bg-green-50 p-4 animate-slide-in">
                            <div class="flex">
                ...
                @if (session('error'))
                    <div class="mx-4 mt-4 sm:mx-6 lg:mx-8">
                        <div class="rounded-md bg-red-50 p-4 animate-slide-in">
                            <div class="flex">
                                <div class="flex-shrink-0">
    ...
    <script>
        ...
        // Auto check for overdue peminjaman every 5 minutes
